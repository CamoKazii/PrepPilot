...
const full = {
  ...
  L3: {
    description: 'Thick and creamy with intact potato, corn and chicken; not floury or watery.',
    prep: '25 min',
    cook: '40 min',
    equipment: '5–6 L heavy pot; stick blender optional',
    ingredients: [
      ['Chicken breast, raw skinless', '800 g'], ['Lean shortcut bacon', '150 g'],
      ['Potatoes, raw edible weight', '700 g'], ['Corn kernels', '350 g'],
      ['Brown onion', '200 g'], ['Carrots, raw edible weight', '250 g'],
      ['Light milk', '600 mL'], ['Light cooking cream', '150 g'],
      ['Prepared reduced-salt stock', '1000 mL'], ['Extra-virgin olive oil', '15 g'],
      ['Plain flour', '40 g'], ['Wholemeal bread', '300 g'], ['Butter', '15 g'],
      ['Dried thyme', '4 g'],
    ],
    method: [
      'Dice chicken, potato, onion and carrot. Heat oil in a heavy pot and brown bacon for 3 minutes. Add chicken and cook until lightly coloured; remove both.',
      'Add onion and carrot and cook 5 minutes. Stir in flour and thyme for 60 seconds.',
      'Gradually add stock, scraping the base. Add potato and simmer 12–15 minutes until nearly tender.',
      'Add corn, milk, cream, chicken and bacon. Simmer gently 6–8 minutes; never boil hard after adding milk.',
      'For extra body, blend two ladles of soup and return them to the pot. Adjust seasoning.',
      'Butter the bread and toast. Divide chowder and toast evenly among five servings.',
    ],
    storage: 'Cool quickly and refrigerate up to 4 days; freeze up to 2 months without the toast.',
    reheat: 'Microwave covered for 3–4 minutes, stirring halfway, until steaming throughout. Add a splash of water if thick.',
    upgrade: 'Finish with sliced spring onion and a squeeze of lemon.',
    assumption: 'Chicken breast is calculated at 1.2% fat. Lean shortcut bacon, light cooking cream, milk, bread and prepared stock profiles materially affect macros.',
  },
};
...
const base = [
  ...
  ['L3', 'Chicken, Corn and Bacon Chowder', 'Lunch', 766, 62.4, 76.4, 19.4],
